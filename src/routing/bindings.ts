...
export function listBindings(cfg: BrainyxConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: BrainyxConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: BrainyxConfig) {
