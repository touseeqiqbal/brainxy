...
function resolveMentionPatterns(cfg: BrainyxConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: BrainyxConfig | undefined, agentId?: string): RegExp[] {
