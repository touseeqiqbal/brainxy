...
import { resolveBootstrapMaxChars } from "../../agents/brainyx-embedded-helpers.js";
import { createBrainyxCodingTools } from "../../agents/brainyx-coding-tools.js";
...
async function resolveContextReport(
  ...
  const tools = (() => {
    try {
      return createBrainyxCodingTools({
        config: params.cfg,
        workspaceDir,
        sessionKey: params.sessionKey,
