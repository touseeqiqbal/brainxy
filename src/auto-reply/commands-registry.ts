import type { BrainyxConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: BrainyxConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: BrainyxConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: BrainyxConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: BrainyxConfig) {
