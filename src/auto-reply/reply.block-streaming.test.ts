...
type RunEmbeddedPiAgent = typeof import("../agents/brainyx-embedded.js").runEmbeddedPiAgent;
...
vi.mock("/src/agents/brainyx-embedded.js", () => piEmbeddedMock);
vi.mock("../agents/brainyx-embedded.js", () => piEmbeddedMock);
vi.mock("../agents/model-catalog.js", () => ({
  loadModelCatalog: vi.fn(),
}));

async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "brainyx-stream-" });
}
