...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@brainyx", { botUsername: "brainyx" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@brainyx args", {
        botUsername: "brainyx",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "brainyx" })).toBe(
      "/help@otherbot",
    );
  });
