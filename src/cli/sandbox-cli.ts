...
const SANDBOX_EXAMPLES = {
  main: [
    ["brainyx sandbox list", "List all sandbox containers."],
    ["brainyx sandbox list --browser", "List only browser containers."],
    ["brainyx sandbox recreate --all", "Recreate all containers."],
    ["brainyx sandbox recreate --session main", "Recreate a specific session."],
    ["brainyx sandbox recreate --agent mybot", "Recreate agent containers."],
    ["brainyx sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["brainyx sandbox list", "List all sandbox containers."],
    ["brainyx sandbox list --browser", "List only browser containers."],
    ["brainyx sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["brainyx sandbox recreate --all", "Recreate all containers."],
    ["brainyx sandbox recreate --session main", "Recreate a specific session."],
    ["brainyx sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["brainyx sandbox recreate --browser --all", "Recreate only browser containers."],
    ["brainyx sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["brainyx sandbox explain", "Show effective sandbox config."],
    ["brainyx sandbox explain --session agent:main:main", "Explain a specific session."],
    ["brainyx sandbox explain --agent work", "Explain an agent sandbox."],
    ["brainyx sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.brainyx.ai/cli/sandbox")}\n`,
    )
    .action(() => {
