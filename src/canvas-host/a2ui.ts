...
export const A2UI_PATH = "/__brainyx__/a2ui";

export const CANVAS_HOST_PATH = "/__brainyx__/canvas";

export const CANVAS_WS_PATH = "/__brainyx__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.brainyxCanvasA2UIAction.postMessage(...)
  // - Android: window.brainyxCanvasA2UIAction.postMessage(...)
  const handlerNames = ["brainyxCanvasA2UIAction"];
  ...
  globalThis.Brainyx = globalThis.Brainyx ?? {};
  globalThis.Brainyx.postMessage = postToNode;
  globalThis.Brainyx.sendUserAction = sendUserAction;
  globalThis.brainyxPostMessage = postToNode;
  globalThis.brainyxSendUserAction = sendUserAction;
