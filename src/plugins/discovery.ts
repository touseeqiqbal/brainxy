...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @brainyx/voice-call -> voice-call).
...
export function discoverBrainyxPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".brainyx", "extensions")];
