...
type WebSearchConfig = NonNullable<BrainyxConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: BrainyxConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("brainyx configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.brainyx.ai/tools/web",
  };
}
...
async function runPerplexitySearch(params: {
  ...
  const res = await fetch(endpoint, {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://brainyx.ai",
      "X-Title": "Brainyx Web Search",
    },
    body: JSON.stringify({
      model: params.model,
      messages: [
