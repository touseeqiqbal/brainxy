...
import { wrapToolWithAbortSignal } from "./brainyx-tools.abort.js";
import {
  filterToolsByPolicy,
...
} from "./brainyx-tools.policy.js";
import {
  assertRequiredParams,
  CLAUDE_PARAM_GROUPS,
  createBrainyxReadTool,
...
} from "./brainyx-tools.read.js";
import { cleanToolSchemaForGemini, normalizeToolParameters } from "./brainyx-tools.schema.js";
import type { AnyAgentTool } from "./brainyx-tools.types.js";
...
function resolveExecConfig(cfg: BrainyxConfig | undefined) {
...
export function createBrainyxCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createBrainyxReadTool(freshReadTool)];
    }
