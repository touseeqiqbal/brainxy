...
import * as helpers from "./brainyx-embedded-helpers.js";
...
// Mock dependencies
vi.mock("./brainyx-embedded-helpers.js", async () => {
  const actual = await vi.importActual("./brainyx-embedded-helpers.js");
  return {
    ...actual,
