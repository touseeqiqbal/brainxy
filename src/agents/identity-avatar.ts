...
function resolveAvatarSource(cfg: BrainyxConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: BrainyxConfig, agentId: string): AgentAvatarResolution {
