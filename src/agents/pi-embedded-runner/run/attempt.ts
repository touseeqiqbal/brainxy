...
import { resolveBrainyxDocsPath } from "../../docs-path.js";
...
import {
  ...
  validateGeminiTurns,
} from "../../brainyx-embedded-helpers.js";
import { subscribeEmbeddedPiSession } from "../../brainyx-embedded-subscribe.js";
import {
  ensurePiCompactionReserveTokens,
  resolveCompactionReserveTokensFloor,
} from "../../brainyx-settings.js";
...
import { toClientToolDefinitions } from "../../brainyx-tool-definition-adapter.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveBrainyxAgentDir();

    // Check if the model supports native image input
    const modelHasVision = params.model.input?.includes("image") ?? false;
    const toolsRaw = params.disableTools
      ? []
      : createBrainyxCodingTools({
        exec: {
    ...
    const docsPath = await resolveBrainyxDocsPath({
      workspaceDir: effectiveWorkspace,
