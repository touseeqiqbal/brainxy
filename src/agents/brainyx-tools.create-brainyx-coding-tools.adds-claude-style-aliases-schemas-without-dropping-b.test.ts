...
describe("createBrainyxCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createBrainyxCodingTools({
      config,
    ...
    const anthropicTools = createBrainyxCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createBrainyxCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createBrainyxCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
