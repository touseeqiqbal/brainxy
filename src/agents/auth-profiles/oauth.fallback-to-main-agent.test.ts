...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveBrainyxAgentDir() returns mainAgentDir
    process.env.BRAINYX_STATE_DIR = tmpDir;
    process.env.BRAINYX_AGENT_DIR = mainAgentDir;
