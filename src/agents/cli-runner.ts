...
import { classifyFailoverReason, isFailoverErrorMessage } from "./brainyx-embedded-helpers.js";
...
export async function runCliAgent(params: {
  ...
  try {
    const output = await enqueueCliRun(queueKey, async () => {
      ...
      const logOutputText = isTruthyEnvValue(process.env.BRAINYX_CLAUDE_CLI_LOG_OUTPUT);
      if (logOutputText) {
