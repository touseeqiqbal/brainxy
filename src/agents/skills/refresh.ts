...
function resolveWatchPaths(workspaceDir: string, config?: BrainyxConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: BrainyxConfig }) {
