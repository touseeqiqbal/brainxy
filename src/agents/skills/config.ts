...
import type { BrainyxConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: BrainyxConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: BrainyxConfig | undefined, pathStr: string): boolean {
...
export function resolveSkillConfig(
  config: BrainyxConfig | undefined,
  skillKey: string,
...
const BUNDLED_SOURCES = new Set(["brainyx-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: BrainyxConfig): string[] | undefined {
