...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Brainyx status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("brainyx security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("brainyx security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.brainyx.ai/faq");
  runtime.log("Troubleshooting: https://docs.brainyx.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("brainyx status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("brainyx logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("brainyx status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("brainyx gateway probe")}`);
  }
}
