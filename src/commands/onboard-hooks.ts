...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.brainyx.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("brainyx hooks list")}`,
      `  ${formatCliCommand("brainyx hooks enable <name>")}`,
      `  ${formatCliCommand("brainyx hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
