...
export function applyZaiConfig(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyOpenrouterProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyOpenrouterConfig(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyMoonshotProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyKimiCodeProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: BrainyxConfig): BrainyxConfig {
...
export function applySyntheticProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyXiaomiProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: BrainyxConfig): BrainyxConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: BrainyxConfig): BrainyxConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: BrainyxConfig): BrainyxConfig {
