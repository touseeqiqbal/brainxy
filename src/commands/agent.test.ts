...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "brainyx-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<BrainyxConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<BrainyxConfig["telegram"]>>,
