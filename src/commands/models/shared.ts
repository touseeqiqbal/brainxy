...
export async function updateConfig(
  mutator: (cfg: BrainyxConfig) => BrainyxConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: BrainyxConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: BrainyxConfig): Set<string> {
