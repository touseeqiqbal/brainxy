...
export const DEFAULT_LOG_DIR = "/tmp/brainyx";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "brainyx.log"); // legacy single-file path

const LOG_PREFIX = "brainyx";
...
function resolveSettings(): ResolvedSettings {
  let cfg: BrainyxConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => BrainyxConfig;
      };
