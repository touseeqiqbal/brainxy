...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "brainyx-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveBrainyxPackageRoot } = await import("./brainyx-root.js");
    ...
    vi.mocked(resolveBrainyxPackageRoot).mockResolvedValue("/opt/brainyx");
