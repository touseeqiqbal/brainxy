...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: BrainyxConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: BrainyxConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: BrainyxConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: BrainyxConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: BrainyxConfig): void {
