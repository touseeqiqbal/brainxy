...
export function resolveTtsConfig(cfg: BrainyxConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.BRAINYX_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: BrainyxConfig): string | undefined {
