...
export function listChannelMessageActions(cfg: BrainyxConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: BrainyxConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: BrainyxConfig): boolean {
  for (const plugin of listChannelPlugins()) {
