...
import { discoverBrainyxPlugins } from "../../plugins/discovery.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { BrainyxPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, BrainyxPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["BRAINYX_PLUGIN_CATALOG_PATHS", "BRAINYX_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<BrainyxPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: BrainyxPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: BrainyxPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverBrainyxPlugins({ workspaceDir: options.workspaceDir });
