...
export type ChannelAgentToolFactory = (params: { cfg?: BrainyxConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: BrainyxConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: BrainyxConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: BrainyxConfig }) => boolean;
  supportsCards?: (params: { cfg: BrainyxConfig }) => boolean;
