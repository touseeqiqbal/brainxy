...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.BRAINYX_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: BrainyxConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: BrainyxConfig): string {
...
function mergeTelegramAccountConfig(cfg: BrainyxConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: BrainyxConfig): ResolvedTelegramAccount[] {
