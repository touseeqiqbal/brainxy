...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof BrainyxConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: BrainyxConfig; env: NodeJS.ProcessEnv }): {
  cfg: BrainyxConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
