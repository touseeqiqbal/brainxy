...
function resolveAnthropicDefaultAuthMode(cfg: BrainyxConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyTalkApiKey(config: BrainyxConfig): BrainyxConfig {
...
export function applyModelDefaults(cfg: BrainyxConfig): BrainyxConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyLoggingDefaults(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyContextPruningDefaults(cfg: BrainyxConfig): BrainyxConfig {
...
export function applyCompactionDefaults(cfg: BrainyxConfig): BrainyxConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
