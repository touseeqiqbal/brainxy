  ...
  .object({
          ...
          .record(
            ...
            z
              .object({
                ...
                cdpUrl: z.string().optional(),
                driver: z.union([z.literal("brainyx"), z.literal("extension")]).optional(),
    ...
    gateway: z
      .object({
        ...
        auth: z
          .object({
            mode: z.union([z.literal("token"), z.literal("password"), z.literal("rbac")]).optional(),
            users: z
              .array(
                z.object({
