...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "brainyx.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.brainyx/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/brainyx"). */
  basePath?: string;
...
export type GatewayAuthUserRole = "admin" | "editor" | "viewer";
...
export type GatewayAuthMode = "token" | "password" | "rbac";
