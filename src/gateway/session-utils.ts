...
import { type BrainyxConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: BrainyxConfig): string[] {
...
export function listAgentsForGateway(cfg: BrainyxConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: BrainyxConfig): string {
...
function resolveSessionStoreAgentId(cfg: BrainyxConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: BrainyxConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: BrainyxConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: BrainyxConfig): GatewaySessionsDefaults {
