...
import type { BrainyxConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: BrainyxConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: BrainyxConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: BrainyxConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: BrainyxConfig) => void;
  log: {
