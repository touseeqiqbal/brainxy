...
export function renderConfig(props: ConfigProps) {
  ...
  return html`
    <div class="config-layout ${props.onboarding ? "config-layout--onboarding" : ""}">
      <!-- Sidebar -->
      <aside class="config-sidebar">
        <div class="config-sidebar__header">
          ${props.onboarding
      ? html`
                <div class="config-sidebar__title">Welcome to Brainyx</div>
                <div class="config-sidebar__subtitle">Setup Wizard</div>
              `
      : html`
