...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["brainyxPollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["brainyx", "pollId"]) ??
    readNestedString(value, ["brainyx", "poll", "id"]) ??
    readNestedString(value, ["data", "brainyxPollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "brainyx", "pollId"]);
    ...
    actions: [
      {
        ...
        title: "Vote",
        data: {
          brainyxPollId: pollId,
          pollId,
        },
        msteams: {
          type: "messageBack",
          text: "brainyx poll vote",
          displayText: "Vote recorded",
          value: { brainyxPollId: pollId, pollId },
        },
      },
    ],
  };
