...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("brainyx/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("brainyx/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
                ...
                try {
                  await sendMessageMatrix(
                    ...
                    [
                      ...
                      "brainyx pairing approve matrix <code>",
                    ].join("\n"),
                    { client },
                  );
                } catch (err) {
