...
Nostr DM channel plugin for Brainyx using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Brainyx. It enables your bot to:
...
```bash
brainyx plugins install @brainyx/nostr
```
...
# Configure brainyx to use local relay
