import type { ChannelOnboardingAdapter, BrainyxConfig, WizardPrompter } from "brainyx/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.brainyx.ai/channels/mattermost",
    ].join("\n"),
