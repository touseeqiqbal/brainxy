...
import { removeAckReactionAfterReply, shouldAckReaction } from "brainyx/plugin-sdk";
import type { BrainyxConfig, PluginRuntime } from "brainyx/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/brainyx") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
