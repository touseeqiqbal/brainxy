...
final class ScreenController {
    ...
    /// Callback invoked when an brainyx:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = BrainyxKitResources.bundle
...
/// Handles navigation policy to intercept brainyx:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept brainyx:// deep links.
        if url.scheme?.lowercased() == "brainyx" {
