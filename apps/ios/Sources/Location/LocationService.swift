...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: BrainyxLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: BrainyxLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: BrainyxLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
