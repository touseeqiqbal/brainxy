...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = BrainyxChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = BrainyxChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
