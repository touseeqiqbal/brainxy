...
public enum BrainyxCanvasA2UICommand: String, Codable, Sendable {
...
public struct BrainyxCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct BrainyxCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
