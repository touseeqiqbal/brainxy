...
public typealias BrainyxPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias BrainyxPlatformImage = UIImage
#endif

public struct BrainyxChatUsageCost: Codable, Hashable, Sendable {
...
public struct BrainyxChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: BrainyxChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(BrainyxChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct BrainyxChatMessageContent: Codable, Hashable, Sendable {
...
public struct BrainyxChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [BrainyxChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: BrainyxChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [BrainyxChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: BrainyxChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(BrainyxChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([BrainyxChatMessageContent].self, forKey: .content) {
...
public struct BrainyxChatHistoryPayload: Codable, Sendable {
...
public struct BrainyxSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct BrainyxSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [BrainyxSessionPreviewItem]
}

public struct BrainyxSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [BrainyxSessionPreviewEntry]

    public init(ts: Int, previews: [BrainyxSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct BrainyxChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct BrainyxChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct BrainyxAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct BrainyxChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct BrainyxGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct BrainyxPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: BrainyxPlatformImage?
...
public struct BrainyxChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
