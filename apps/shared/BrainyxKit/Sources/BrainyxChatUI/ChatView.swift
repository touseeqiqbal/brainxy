...
@MainActor
public struct BrainyxChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: BrainyxChatViewModel
    ...
    public init(
        viewModel: BrainyxChatViewModel,
    ...
    private var visibleMessages: [BrainyxChatMessage] {
        let base: [BrainyxChatMessage]
    ...
    private func mergeToolResults(in messages: [BrainyxChatMessage]) -> [BrainyxChatMessage] {
    ...
    private func isToolResultMessage(_ message: BrainyxChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: BrainyxChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: BrainyxChatMessage) -> String {
