...
@MainActor
struct BrainyxChatComposer: View {
    @Bindable var viewModel: BrainyxChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(BrainyxChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(BrainyxChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \BrainyxPendingAttachment.id)
                { (att: BrainyxPendingAttachment) in
                    HStack(spacing: 6) {
                        if let img = att.preview {
                            BrainyxPlatformImageFactory.image(img)
                                .resizable()
                                .scaledToFill()
    ...
    private var editor: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(BrainyxChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(BrainyxChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(BrainyxChatTheme.subtleCard)
        .clipShape(Capsule())
    }
