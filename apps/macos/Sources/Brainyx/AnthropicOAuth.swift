...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Brainyx token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: BrainyxOAuthStore.AnthropicOAuthStatus = BrainyxOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.brainyx", category: "anthropic-oauth")
...
enum BrainyxOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let brainyxOAuthDirEnv = "BRAINYX_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Brainyx OAuth token file not found"
            case .unreadableFile: "Brainyx OAuth token file not readable"
            case .invalidJSON: "Brainyx OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Brainyx OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Brainyx OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.brainyxOAuthDirEnv]?
