...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = BrainyxConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = BrainyxConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = BrainyxConfigFile.loadDict()
            ...
            BrainyxConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/brainyx"
        state.remoteCliPath = ""
        return state
    }
}
