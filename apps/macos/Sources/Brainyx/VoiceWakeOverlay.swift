...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.brainyx", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Brainyx windows, but below the system’s pop-up menus.
