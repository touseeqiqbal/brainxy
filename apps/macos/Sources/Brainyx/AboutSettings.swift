...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/brainyx/brainyx") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/brainyx/brainyx")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://brainyx.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "BrainyxBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "BrainyxBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "BrainyxGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "BrainyxGitCommit") as? String) ??
            "unknown"
    }
