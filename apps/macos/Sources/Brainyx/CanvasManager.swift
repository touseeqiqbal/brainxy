...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.brainyx", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Brainyx/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__brainyx__/a2ui/").absoluteString + "?platform=macos"
    }
