...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.brainyx", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return BrainyxConfigFile.defaultWorkspaceURL() }
