...
enum UIStrings {
    static let welcomeTitle = "Welcome to Brainyx"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: BrainyxOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: BrainyxChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g brainyx@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: BrainyxChatViewModel(
