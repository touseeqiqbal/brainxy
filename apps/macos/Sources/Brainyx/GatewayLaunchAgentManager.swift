...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.brainyx", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".brainyx/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.brainyxCommand(
            subcommand: "gateway",
