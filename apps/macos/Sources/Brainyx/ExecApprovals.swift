...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.brainyx", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        BrainyxPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        BrainyxPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
