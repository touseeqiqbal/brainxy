...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.brainyx", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.brainyx", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [BrainyxChatMessage] = messages.compactMap { item in
