...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .brainyxSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? BrainyxPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? BrainyxPaths.stateDirURL.path
...
extension Notification.Name {
    static let brainyxSelectSettingsTab = Notification.Name("brainyxSelectSettingsTab")
}
